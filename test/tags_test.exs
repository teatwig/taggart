defmodule TagsTest do
  ...
  test "with attributes (void tags)" do
    ...
    assert "<embed class=\"attr\" id=\"bar\">" ==
             embed(class: "attr", id: "bar") |> safe_to_string
  end
  ...
  test "with attributes" do
    ...
    assert "<div class=\"attr\" id=\"bar\"></div>" ==
             div(class: "attr", id: "bar") |> safe_to_string

    assert "<span class=\"attr\" id=\"bar\"></span>" ==
  ...
  test "with content as an arg, and attrs" do
    ...
    assert "<div class=\"foo\" id=\"bar\">content</div>" ==
             div("content", class: "foo", id: "bar") |> safe_to_string
  ...
  test "with content as an arg, and do attrs" do
    ...
    assert "<div do=\"do_arg\" id=\"bar\">content</div>" ==
             div("content", do: "do_arg", id: "bar") |> safe_to_string

    assert "<span do=\"do_arg\" id=\"bar\">content</span>" ==
             span("content", do: "do_arg", id: "bar") |> safe_to_string
  end
  ...
  test "with do block with content" do
    assert "<div>content</div>" ==
             (div do
                "content"
              end)
             |> safe_to_string

    assert "<span>content</span>" ==
             (span do
                "content"
              end)
             |> safe_to_string
  ...
  test "with do block with content and attrs" do
    assert "<div class=\"foo\">content</div>" ==
             (div(class: "foo") do
                "content"
              end)
             |> safe_to_string

    assert "<span class=\"foo\">content</span>" ==
             (span(class: "foo") do
                "content"
              end)
             |> safe_to_string
  ...
  test "with do block with empty content and attrs with do" do
    assert "<div do=\"do_attr\"></div>" ==
             (div(do: "do_attr") do
              end)
             |> safe_to_string

    assert "<span do=\"do_attr\"></span>" ==
             (span(do: "do_attr") do
              end)
             |> safe_to_string

    assert "<div do=\"do_attr\" id=\"bar\"></div>" ==
             (div(do: "do_attr", id: "bar") do
              end)
             |> safe_to_string

    assert "<span do=\"do_attr\" id=\"bar\"></span>" ==
             (span(do: "do_attr", id: "bar") do
              end)
             |> safe_to_string
  end

  test "with do block with content and attrs with do" do
    assert "<div do=\"do_attr\">content</div>" ==
             (div(do: "do_attr") do
                "content"
              end)
             |> safe_to_string

    assert "<span do=\"do_attr\">content</span>" ==
             (span(do: "do_attr") do
                "content"
              end)
             |> safe_to_string

    assert "<div do=\"do_attr\" id=\"bar\">content</div>" ==
             (div(do: "do_attr", id: "bar") do
                "content"
              end)
             |> safe_to_string

    assert "<span do=\"do_attr\" id=\"bar\">content</span>" ==
             (span(do: "do_attr", id: "bar") do
                "content"
              end)
             |> safe_to_string
  ...
  test "with more deeply nested do blocks" do
    assert "<div><div><div></div></div></div>" ==
             (div do
                div do
                  div do
                  end
    ...
    assert "<div><span><div><span></span></div></span></div>" ==
             (div do
                span do
                  div do
                    span do
  ...
  test "with siblings blocks" do
    ...
    assert "<div><span></span><div></div></div>" ==
             (div do
                span do
                end
  ...
  test "with nested calls with attrs" do
    assert "<div class=\"foo\"><div class=\"bar\"></div></div>" ==
             div(div(class: "bar"), class: "foo") |> safe_to_string

    assert "<span class=\"foo\"><span class=\"bar\"></span></span>" ==
             span(span(class: "bar"), class: "foo") |> safe_to_string
  end
  ...
  test "with more deeply nested do blocks with attrs" do
    assert "<div class=\"foo\"><div class=\"bar\"><div class=\"baz\"></div></div></div>" ==
             (div(class: "foo") do
                div(class: "bar") do
                  div(class: "baz") do
                  end
    ...
    assert "<span class=\"foo\"><span class=\"bar\"><span class=\"baz\"></span></span></span>" ==
             (span(class: "foo") do
                span(class: "bar") do
                  span(class: "baz") do
                  end
    ...
    assert "<div class=\"foo\"><span class=\"bar\"><div class=\"baz\"><span class=\"bang\"></span></div></span></div>" ==
             (div(class: "foo") do
                span(class: "bar") do
                  div(class: "baz") do
                    span(class: "bang") do
  ...
  test "with siblings blocks with attrs" do
    assert "<div class=\"foo\"><div class=\"bar\"></div><div class=\"baz\"></div></div>" ==
             (div(class: "foo") do
                div(class: "bar") do
                end
    ...
    assert "<span class=\"foo\"><span class=\"bar\"></span><span class=\"baz\"></span></span>" ==
             (span(class: "foo") do
                span(class: "bar") do
                end
    ...
    assert "<div class=\"foo\"><span class=\"bar\"></span><div class=\"baz\"></div></div>" ==
             (div(class: "foo") do
                span(class: "bar") do
                end
  ...
  test "normal html" do
    ...
    assert "<html><body><div><h3>Person</h3><p class=\"name\">Vincent</p><p class=\"age\">38</p></div></body></html>" ==
             html
  end
  ...
  test "doctypes" do
    ...
    assert ~s|<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">| ==
             html_doctype(:html401_strict) |> safe_to_string

    assert ~s|<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">| ==
             html_doctype(:html401_transitional) |> safe_to_string

    assert ~s|<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Frameset//EN" "http://www.w3.org/TR/html4/frameset.dtd">| ==
             html_doctype(:html401_frameset) |> safe_to_string

    assert ~s|<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">| ==
             html_doctype(:xhtml10_strict) |> safe_to_string

    assert ~s|<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">| ==
             html_doctype(:xhtml10_transitional) |> safe_to_string

    assert ~s|<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">| ==
             html_doctype(:xhtml10_frameset) |> safe_to_string

    assert ~s|<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">| ==
             html_doctype(:xhtml11) |> safe_to_string
  end

  test "an html comment" do
    assert "<!-- this is a string comment -->" ==
             html_comment("this is a string comment") |> safe_to_string
  end
